...
pub fn parse_var_declaration<'a>(tokens: &mut Vec<Token>) -> Result<Stmt, ParserError<'a>> {
...
pub fn parse_print_statement<'a>(
    tokens: &mut Vec<Token>,
    new_line: bool,
) -> Result<Stmt, ParserError<'a>> {
    eat(tokens);
    if at(tokens).token_type == TokenType::SEMICOLON {
        eat(tokens);
...
pub fn parse_if_else_statement<'a>(tokens: &mut Vec<Token>) -> Result<Stmt, ParserError<'a>> {
    eat(tokens);
    let expr = parse_expr(tokens)?;
    expect(
        tokens,
...
pub fn parse_for_statement<'a>(tokens: &mut Vec<Token>) -> Result<Stmt, ParserError<'a>> {
    eat(tokens);
...
pub fn parse_while_statement<'a>(tokens: &mut Vec<Token>) -> Result<Stmt, ParserError<'a>> {
    eat(tokens);
    let expr = parse_expr(tokens)?;
    expect(
        tokens,
...
pub fn parse_block_statement<'a>(tokens: &mut Vec<Token>) -> Result<Stmt, ParserError<'a>> {
    eat(tokens);
    let mut stmts = vec![];
    while at(tokens).token_type != TokenType::RIGHTBRACE {
...
pub fn parse_function_statement<'a>(tokens: &mut Vec<Token>) -> Result<Stmt, ParserError<'a>> {
    eat(tokens);
...
pub fn parse_class_statement<'a>(tokens: &mut Vec<Token>) -> Result<Stmt, ParserError<'a>> {
    eat(tokens);
